...
# Function to train Decision Tree and report metrics
...
# Train Decision Tree and report metrics for 'readmitted'
...
# Train Decision Tree and report metrics for 'time_in_hospital'
