...
# Function to train BaggingClassifier and report metrics
def train_bagging_classifier_and_report_metrics(file_path, target_column):
    ...
    # Initialize BaggingClassifier with Decision Trees as base estimator
...
# Train BaggingClassifier and report metrics for 'readmitted'
...
# Train BaggingClassifier and report metrics for 'time_in_hospital'
