...
def metrics_report(tree, test_data):
    ...
    for index, row in test_data.iterrows():
        ...
        while current_node.label is None:
            ...
            if current_node is None:
                predict_label = default_prediction  # Use default prediction
                break
    ...
    # Ensure all predictions are valid for metric calculations
    ...
    if len(set(actual)) == 2:
        ...
        auc = None  # AUC is typically for binary classification
